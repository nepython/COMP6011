...
from utils import configure_seed, configure_device, compute_scores, Dataset_for_RNN, plot_losses, compute_metrics
...
def main():
    ...
    model = GRU_att(input_size, hidden_size, num_layers, n_classes, dropout_rate=opt.dropout, gpu_id=opt.gpu_id,
